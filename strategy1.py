...
DROPOUT_RATE = 0.30            # Standard dropout rate

# --- TRANSFORMER-specific ---
NUM_TRANSFORMER_BLOCKS = 3     # Depth of attention stack
...
CONFIDENCE_THRESHOLD = 0.55    # Probability requirement (0.0 to 1.0)
MAX_UNCERTAINTY = 0.20         # MAX ALLOWED STD: If variance is higher, force HOLD
MC_SAMPLES = 150               # Samples used for Mean/STD calculation
